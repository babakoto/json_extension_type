...
class JsonExtensionGenerator {
  void generate(String libPath) {
    print('🔍 Searching for _model.dart files in $libPath...\n');
    ...
    if (modelFiles.isEmpty) {
      print('❌ No _model.dart files found');
      return;
    }

    print('✅ Found ${modelFiles.length} _model.dart file(s)\n');

    for (final modelFile in modelFiles) {
      print('📝 Processing: ${modelFile.path}');
  ...
  void _generateExtensionForModel(File modelFile) {
    ...
    if (models.isEmpty) {
      print('   ⚠️  No typedef or class found');
      return;
    }
    ...
    print('   ✅ Extensions added to: ${modelFile.path}');
  }
